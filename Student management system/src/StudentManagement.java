...
//		Creating new frame for the components
    ...
    frmStduentManagementSystem.setBounds(100, 100, 1200, 600);
...
//		Adding the UI components
    ...
    inputPanel.setBackground(new Color(190, 195, 135));
    ...
    rollNumberTextField.setHorizontalAlignment(SwingConstants.LEFT);
...
//		Adding the update button action listener to update the student data on click
    ...
    outputPanel.setBounds(400, 0, 750, 565);
    outputPanel.setBackground(new Color(155, 240, 54));
      ...
      public void actionPerformed(ActionEvent e) {
        // TODO Auto-generated method stub
          try {
            ...
            JOptionPane.showMessageDialog(outputPanel,"Student successfully found","Searched", JOptionPane.INFORMATION_MESSAGE);
